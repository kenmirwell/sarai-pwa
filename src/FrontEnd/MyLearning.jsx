...
const MyLearning = () => {
  const recommended = "Agribusiness"
  const recomCourses = Courses.filter((i) => i.category === recommended)
    ...
    <div className="pb-[50px]">
      <div className="w-[100%] bg-[#606060]">
        <div className="max-w-[1200px] px-[50px] mx-auto pt-[20px]">
            <div className="flex justify-between items-start">
              <div>
                <h1 className="text-[32px] text-[#ffffff] pb-[20px]">My Learning</h1>
      ...
      <div className="w-[100%]">
        <div className="max-w-[1200px] px-[50px] mx-auto pt-[50px]">
          <h2 className="text-[24px] text-[#000000] pb-[20px]">Recommended</h2>
          {
            recomCourses &&
            <div className="flex gap-[20px]">
              {
                recomCourses.map((i, index) => (
                  <CourseCard
                    title={i.title}
